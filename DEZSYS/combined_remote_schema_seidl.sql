...
DROP FOREIGN TABLE IF EXISTS combined.remote_customers_us_name_phone;
CREATE FOREIGN TABLE combined.remote_customers_us_name_phone(
	customerid INTEGER NOT NULL,
	lastname VARCHAR(50) NOT NULL,
	firstname VARCHAR(50) NOT NULL,
	address1 VARCHAR(50) NOT NULL,
...
OPTIONS (
    schema_name 'combined', table_name 'customers_us_name_phone'
);

DROP FOREIGN TABLE IF EXISTS combined.remote_cutomers_non_us_name_phone;
CREATE FOREIGN TABLE combined.remote_cutomers_non_us_name_phone(
	customerid INTEGER NOT NULL,
	email VARCHAR(50),
	creditcardtype VARCHAR(50) NOT NULL,
	creditcard VARCHAR(50) NOT NULL,
...
SERVER foreign_server
OPTIONS (
    schema_name 'combined', table_name 'customers_non_us_name_phone'
);